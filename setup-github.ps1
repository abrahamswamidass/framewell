...
"@
gh issue create --repo $repo --title "Set up SQLite database schema for photo metadata" --label "dev" --milestone "v0.1 — indexing" --body $body
...
"@
gh issue create --repo $repo --title "Implement Synology NAS file indexer (SMB mount)" --label "dev" --milestone "v0.1 — indexing" --body $body
...
"@
gh issue create --repo $repo --title "Implement Google Drive file indexer" --label "dev" --milestone "v0.1 — indexing" --body $body
...
"@
gh issue create --repo $repo --title "Implement partial + full file hashing" --label "dev" --milestone "v0.1 — indexing" --body $body
...
"@
gh issue create --repo $repo --title "Periodic re-scan scheduler" --label "dev" --milestone "v0.1 — indexing" --body $body
...
"@
gh issue create --repo $repo --title "Exact duplicate detection algorithm" --label "dev" --milestone "v0.2 — duplicates" --body $body
...
"@
gh issue create --repo $repo --title "Define canonical photo selection rules" --label "idea" --milestone "v0.2 — duplicates" --body $body
...
"@
gh issue create --repo $repo --title "Store and expose duplicate metadata" --label "dev" --milestone "v0.2 — duplicates" --body $body
...
"@
gh issue create --repo $repo --title "Design duplicate tree view UI" --label "design" --milestone "v0.3 — tree view" --body $body
...
"@
gh issue create --repo $repo --title "Build local web UI (server + frontend)" --label "dev" --milestone "v0.3 — tree view" --body $body
...
- Audit log queryable
"@
gh issue create --repo $repo --title "Implement safe file deletion flow" --label "dev" --milestone "v0.3 — tree view" --body $body
...
"@
gh issue create --repo $repo --title "Research Amazon Photos upload API" --label "idea" --milestone "v1.0 — alexa" --body $body
...
"@
gh issue create --repo $repo --title "Define 'interesting photo' scoring algorithm" --label "idea" --milestone "v1.0 — alexa" --body $body
...
"@
gh issue create --repo $repo --title "Implement photo scoring and recommendation engine" --label "dev" --milestone "v1.0 — alexa" --body $body
...
"@
gh issue create --repo $repo --title "Implement Amazon Photos sync" --label "dev" --milestone "v1.0 — alexa" --body $body
